...
public class WhileLoopTAC extends ThreeAddrCode {
  private static final String TAC_FORMAT = "WHILE %s %s %s GOTO %s";
  private GotoTAC gotoTAC;

  public WhileLoopTAC(Symbol arg1, Symbol arg2, Symbol op, Label result) {
